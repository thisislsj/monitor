...
public class SensorLogController {
    ...
    @GetMapping(value = "/{sensorCode}")
    public List<SensorLog> getAllLogsBySensorCode(@PathVariable String sensorCode){

        return sensorLogService.findAllBySensorCode(sensorCode);
